...
aggmet2007_tmmx_matrix_transposed <- as.matrix(aggmet2007_tmmx_raster_transposed)
...
aggmet2007_tmin_matrix_transposed <- as.matrix(aggmet2007_tmin_raster_transposed)
...
aggmet2007_minrh_matrix_transposed <- as.matrix(aggmet2007_minrh_raster_transposed)
...
aggmet2007_maxrh_matrix_transposed <- as.matrix(aggmet2007_maxrh_raster_transposed)
...
aggmet2007_windspeed_matrix_transposed <- as.matrix(aggmet2007_windspeed_raster_transposed)
