#------------------------------------------------------------------------#
# TITLE:        week6exercise_distributions2.R
#
...
# DATE:         23 Sept. 2014
#
# COMMENTS:     This file contains code to test the fit of dataset to varying 
#               distributions - final version
#
#
...
#----var1 plots for all four distributions - where possible------#
...
hist(var1, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
     ...
     xlab = "Var1",
     main = paste("Normal Distribution fit to Var1\n", "mu = ", mu, "; sigma = ", sigma))
...
#--------var2 plots for all four distributions - where possible------#
  ...
  #b = 250 # Set the scale parameter, b.
  #c = 3.0  # Set the shape parameter, c.
  #randWbl = sort(rweibull(n = n, scale = b,shape = c))  
  ...
  hist(var2, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var2",
       main = paste("Normal Distribution fit to Var2\n","mu = ", mu, "; sigma = ", sigma))
  lines(sort(var2),nHat,lwd=2)
  text(min(var2),max(nHat), pos = 4,
       paste("Fit: mu = ",round(muHat*100)/100))
  text(min(var2),0.9*max(nHat), pos = 4,
       paste("sigma = ", round(sigmaHat*100)/100))
  ...
  hist(var2,breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
      ylab = "Probability density",
      xlab = "Var2",
      main = paste("Exponential Distribution fit to Var2\n","mu = ", muExp))
  points(var2,nHat,lwd=2)
  ...
  hist(var2, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var2",
       main = paste("Weibull Distribution fit to Var2"))
...
#--------var3 plots for all four distributions - where possible------#
  ...
  hist(var3, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var3",
       main = paste("Normal Distribution fit to Var3\n","mu = ", mu, "; sigma = ", sigma))
  points(sort(var3),nHat,lwd=2)
  ...
  hist(var3,breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var3",
       main = paste("Exponential Distribution fit to Var3\n","mu = ", muExp))
  points(var3,nHat,lwd=2)
  ...
  hist(var3, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var3",
       main = paste("Weibull Distribution fit to Var3\n","b = ", b,"; c = ", c))
  points(var3,nHat,lwd=2)
  text(max(var3),max(nHat), pos = 2,
       paste("Fit: b = ", round(bHat*100)/100, "; c = ", round(cHat*100)/100))
...
#--------var4 plots for all four distributions - where possible------#
  ...
  hist(var4, breaks=50, freq = FALSE, col=rgb(0.75,0.75,0.75),
       ylab = "Probability density",
       xlab = "Var4",
       main = paste("Normal Distribution fit to Var4\n","mu = ", mu, "; sigma = ", sigma))
